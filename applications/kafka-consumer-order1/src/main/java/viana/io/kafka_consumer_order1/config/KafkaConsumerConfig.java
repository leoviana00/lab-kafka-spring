package viana.io.kafka_consumer_order1.config;
...
public class KafkaConsumerConfig {
        ...
        public ConsumerFactory<String, OrderRecord> orderConsumerFactory() {
                ...
                props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "viana.io.kafka_consumer_order1.record.OrderRecord"); // Configurar
