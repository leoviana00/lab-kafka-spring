package viana.io.kafka_consumer_order2.config;
...
public class KafkaConsumerConfig {
        ...
        public ConsumerFactory<String, OrderRecord> orderConsumerFactory() {
                ...
                props.put(ConsumerConfig.GROUP_ID_CONFIG, "lab-order-processed");
                props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, ErrorHandlingDeserializer.class);
                props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, ErrorHandlingDeserializer.class);
                props.put(ErrorHandlingDeserializer.KEY_DESERIALIZER_CLASS, JsonDeserializer.class);
                props.put(ErrorHandlingDeserializer.VALUE_DESERIALIZER_CLASS, JsonDeserializer.class.getName());
                props.put(JsonDeserializer.TRUSTED_PACKAGES, "*");
                props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "viana.io.kafka_consumer_order2.record.OrderRecord"); // Configurar
